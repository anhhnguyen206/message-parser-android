 ...
 */
public class ExtractMetadataAsJsonStringInteractorImpl implements ExtractMetadataAsJsonStringInteractor {
    private MentionParser mMentionParser;
    private EmoticonParser mEmoticonParser;
    private LinkParser mLinkParser;

    @Inject
    public ExtractMetadataAsJsonStringInteractorImpl(MentionParser mentionParser, EmoticonParser emoticonParser, LinkParser linkParser) {
    ...
    @Override
    public Observable<String> execute(final String message) {
        return Observable.create(new Observable.OnSubscribe<String>() {
            ...
            public void call(Subscriber<? super String> subscriber) {
                ...
                subscriber.onNext(gson.toJson(messageMetadata));
